...
function traverse(tree, walker2, origin) {
  ...
  if (!isArray(tree)) {
    forEach(tree, function(subtree, key) {
      return traverse(subtree, walker2, __spreadArray3(__spreadArray3([], __read4(origin)), __read4(parsePath(key))));
    });
    return;
  }
  var _a = __read4(tree, 2), nodeValue = _a[0], children = _a[1];
  if (children) {
    forEach(children, function(child, key) {
      traverse(child, walker2, __spreadArray3(__spreadArray3([], __read4(origin)), __read4(parsePath(key))));
    });
  }
...
function applyReferentialEqualityAnnotations(plain, annotations) {
  ...
  if (isArray(annotations)) {
    var _a = __read4(annotations, 2), root = _a[0], other = _a[1];
...
function generateReferentialEqualityAnnotations(identitites) {
  ...
  identitites.forEach(function(paths) {
    ...
    var _a = __read4(paths.map(function(path) {
...
var walker = function(object, identities, path, objectsInThisPath) {
  ...
  forEach(transformed, function(value, index) {
    var recursiveResult = walker(value, identities, __spreadArray3(__spreadArray3([], __read4(path)), [index]), objectsInThisPath);
...
var DefaultRenderer = ({
  ...
  return React6.createElement(Entry, {
    ...
    expanded
  }), " ", label, " ", React6.createElement(Info, null, String(type).toLowerCase() === "iterable" ? "(Iterable) " : "", subEntries.length, " ", subEntries.length > 1 ? "items" : "item")), expanded ? subEntryPages.length === 1 ? React6.createElement(SubEntries, null, subEntries.map(handleEntry)) : React6.createElement(SubEntries, null, subEntryPages.map((entries, index) => React6.createElement("div", {
    key: index
...
function ReactQueryDevtools({
  ...
  }), "Close") : null), !isResolvedOpen ? React8.createElement("button", _extends({
    type: "button"
  }, otherToggleButtonProps, {
...
var ReactQueryDevtoolsPanel = React8.forwardRef(function ReactQueryDevtoolsPanel2(props, ref) {
  ...
  }, panelProps), React8.createElement("style", {
    nonce: styleNonce,
  ...
  }, sortDesc ? "\u2B07 Desc" : "\u2B06 Asc"), React8.createElement(Button, {
    type: "button",
    onClick: () => {
      if (isMockOffline) {
...
var ActiveQuery = ({
  ...
  }, JSON.stringify(activeQuery.queryKey, null, 2))), React8.createElement("span", {
    style: {
      padding: "0.3em .6em",
      borderRadius: "0.4em",
      fontWeight: "bold",
...
var QueryStatusCount = ({
  ...
  return React8.createElement(QueryKeys, {
    style: {
      marginBottom: ".5em"
    }
  }, React8.createElement(QueryKey, {
    style: {
